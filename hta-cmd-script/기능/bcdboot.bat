...
Repair-VirtualDisk -FriendlyName "DataDisk1" -WhatIf

Get-VirtualDisk
Repair-VirtualDisk -FriendlyName "BackupDisk"

Get-VHD -Path "C:\경로\파일.vhdx"
Mount-VHD -Path "C:\경로\파일.vhdx"

Import-Module Hyper-V
Get-VHD -Path "J:\bb.vhd"
Mount-VHD -Path "J:\bb.vhd"
